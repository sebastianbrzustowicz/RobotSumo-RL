...
class SACAgent(nn.Module):
    def __init__(self, obs_size, action_dim, device, hidden_dim=256, lr=3e-4):
        ...
        self.actor = GaussianActor(obs_size, action_dim, hidden_dim, hidden_dim).to(device)
        ...
        self.q1_target = QNetwork(obs_size, action_dim, hidden_dim, hidden_dim).to(device)
        self.q2_target = QNetwork(obs_size, action_dim, hidden_dim, hidden_dim).to(device)
